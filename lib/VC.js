    ...
    async diff (commitOrCommitId) {
      ...
      return commitToDiff.changes.reduce((res, c) => {
        ...
        if (c.operation === 'update') {
          ...
          patch = JSON.parse(patches.createPatch(c.path, previousEntity.entity, afterEntity.entity, c.entitySet, { context: Number.MAX_VALUE, bufferEncoding: 'utf8' }))
        }
